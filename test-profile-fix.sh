...
if grep -q "PORT=80" /home/jzhu/projects/repos/vibecoding-exercise/start-dev.sh; then
...
if grep -q "PORT=80" /home/jzhu/projects/repos/vibecoding-exercise/frontend/package.json; then
...
if grep -q "http://localhost:80" /home/jzhu/projects/repos/vibecoding-exercise/backend/oauth_backend.py; then
